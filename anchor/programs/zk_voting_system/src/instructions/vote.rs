...
pub fn vote_handler(ctx: Context<Vote>, name: String, proof_a: [u8; 64], proof_b: [u8; 128], proof_c: [u8; 64], merkle_rootmembership_merkle_root: [u8; 32], new_spent_root: [u8;32], spent_nullifiers_ipfs_cid: String, option: String) -> Result<()> {
